...
**Generalized into a platform rule (2026-07-11,** [ai-agent-bridge.md](ai-agent-bridge.md)
**"Authorization And Delegation"):** the thin Core proxy twin is the right call only for admin-only,
