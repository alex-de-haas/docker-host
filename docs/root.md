...
- [Runtime artifact & storage model](features/runtime-artifact-model.md) - design: execution × artifact-kind (image/prebuilt/source) axes, per-runtime storage, and the compiled-artifact (`prebuilt`) path. Phased; Phase 0 shipped.
