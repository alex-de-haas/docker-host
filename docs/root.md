...
- [Notifications](features/notifications.md) - design draft: Core-owned user-targeted notification stream, opt-in app producers, client-agnostic / MCP-legible consumer.
