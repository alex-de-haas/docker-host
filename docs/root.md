...
- [Assistant app context](features/assistant-app-context/plan.md) - persistent multi-app selection
...
- **app-authoring** — [plan](features/app-authoring/plan.md): Draft, updated 2026-09-16
...
- **app-development-controls** — [plan](features/app-development-controls/plan.md): Draft, updated 2026-09-16
- **app-lifecycle-states** — [feature](features/app-lifecycle-states/feature.md)
- **app-mcp** — [feature](features/app-mcp/feature.md)
- **app-prototype-workspaces** — [plan](features/app-prototype-workspaces/plan.md): Draft, updated 2026-09-16
...
- **assistant-app-context** — [plan](features/assistant-app-context/plan.md): Draft, updated 2026-09-16
- **assistant-approval-rules** — [plan](features/assistant-approval-rules/plan.md): Draft, updated 2026-09-16
