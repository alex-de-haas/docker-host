...
- [Cross-app dependencies](features/cross-app-dependencies/feature.md) - declare a dependency on another installed app; Core wires `HOSTY_DEPENDENCY_{ALIAS}_URL` and warns when a dependency is missing/not running (no auth, no auto-install).
...
- **app-lifecycle-states** — [plan](features/app-lifecycle-states/plan.md): Draft, updated 2026-07-28
- **core-event-bus** — [feature](features/core-event-bus/feature.md)
- **cross-app-dependencies** — [feature](features/cross-app-dependencies/feature.md) · [plan](features/cross-app-dependencies/plan.md): Ready, updated 2026-07-28
