...
- **agent-background-sessions** — [plan](features/agent-background-sessions/plan.md): Draft, updated 2026-08-13
- **ai-agent-bridge** — [feature](features/ai-agent-bridge/feature.md) · [plan](features/ai-agent-bridge/plan.md): In Progress, updated 2026-08-14
- **ai-gateway** — [feature](features/ai-gateway/feature.md) · [plan](features/ai-gateway/plan.md): In Progress, updated 2026-08-11
...
- **delegated-token-exchange** — [plan](features/delegated-token-exchange/plan.md): Draft, updated 2026-08-13
