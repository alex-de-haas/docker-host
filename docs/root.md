...
- **ai-agent-bridge** — [feature](features/ai-agent-bridge/feature.md) · [plan](features/ai-agent-bridge/plan.md): In Progress, updated 2026-09-16
...
- **app-authoring** — [plan](features/app-authoring/plan.md): Draft, updated 2026-09-17
...
- **app-development-controls** — [plan](features/app-development-controls/plan.md): Draft, updated 2026-09-17
- **app-lifecycle-states** — [feature](features/app-lifecycle-states/feature.md)
- **app-mcp** — [feature](features/app-mcp/feature.md)
- **app-prototype-workspaces** — [plan](features/app-prototype-workspaces/plan.md): Draft, updated 2026-09-17
- **app-provided-skills** — [feature](features/app-provided-skills/feature.md)
- **app-publication** — [plan](features/app-publication/plan.md): Draft, updated 2026-09-16
...
- **assistant-approval-rules** — [plan](features/assistant-approval-rules/plan.md): Draft, updated 2026-09-18
...
- **dependency-ordered-autostart** — [plan](features/dependency-ordered-autostart/plan.md): Draft, updated 2026-09-16
...
- **hosty-app-sdk** — [feature](features/hosty-app-sdk/feature.md) · [plan](features/hosty-app-sdk/plan.md): In Progress, updated 2026-09-07
