...
- **ai-agent-bridge** — [feature](features/ai-agent-bridge/feature.md) · [plan](features/ai-agent-bridge/plan.md): In Progress, updated 2026-08-31
...
- **core-public-origin** — [plan](features/core-public-origin/plan.md): Draft, updated 2026-09-01
- **core-read-path-caching** — [feature](features/core-read-path-caching/feature.md)
- **core-runtime-parameters** — [plan](features/core-runtime-parameters/plan.md): In Progress, updated 2026-09-01
