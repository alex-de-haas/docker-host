...
The direction it is built toward — a tightly integrated pair of hosting platform and agent harness,
...
- **agent-background-sessions** — [plan](features/agent-background-sessions/plan.md): In Progress, updated 2026-08-18
- **ai-agent-bridge** — [feature](features/ai-agent-bridge/feature.md) · [plan](features/ai-agent-bridge/plan.md): In Progress, updated 2026-08-17
...
- **app-ui-surfaces** — [plan](features/app-ui-surfaces/plan.md): Ready, updated 2026-08-18
- **assistant-entry-points** — [plan](features/assistant-entry-points/plan.md): Ready, updated 2026-08-18
...
- **delegated-token-exchange** — [feature](features/delegated-token-exchange/feature.md) · [plan](features/delegated-token-exchange/plan.md): In Progress, updated 2026-08-17
