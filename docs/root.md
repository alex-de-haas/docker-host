...
- **core-event-bus** — [plan](features/core-event-bus/plan.md): In Progress, updated 2026-07-24

### Legacy documents (pre-migration)

- [features/ai-agent-bridge](features/ai-agent-bridge.md) — Draft; key decisions recorded 2026-07-11 (marked "Decided" below).
...
- [features/auth-gateway](features/auth-gateway.md)
- [features/automatic-runtime-app-ports](features/automatic-runtime-app-ports.md)
...
- [features/cloudflared-ingress](features/cloudflared-ingress.md)
- [features/container-capabilities](features/container-capabilities.md)
- [features/core-api](features/core-api.md)
- [features/core-app-shell](features/core-app-shell.md)
- [features/cross-app-dependencies](features/cross-app-dependencies.md)
...
- [features/global-mounts](features/global-mounts.md)
...
- [features/local-password-login](features/local-password-login.md)
...
- [features/observability-phase-2-backend](features/observability-phase-2-backend.md) — **2a–2c + manifest + 2c-shell + UI-as-system-app implemented; Core telemetry read proxy removed; only 2d (SSE) remains.**
- [features/observability](features/observability.md)
- [features/raw-ports](features/raw-ports.md)
- [features/repository-release-model](features/repository-release-model.md)
...
- [features/runtime-app-marketplace](features/runtime-app-marketplace.md)
- [features/runtime-app-update](features/runtime-app-update.md)
...
- [features/shell-access-and-system-apps](features/shell-access-and-system-apps.md)
- [features/shell-route-navigation](features/shell-route-navigation.md)
- [features/user-management](features/user-management.md)
- [features/web-ui-dashboard](features/web-ui-dashboard.md)
...
- [ideas/generic-bootstrap](ideas/generic-bootstrap.md) — Idea
- [ideas/hosty-app-sdk](ideas/hosty-app-sdk.md) — Phase 1 (auth) shipped and adopted — second wave open (see Adoption Status)
- [ideas/install-time-runtime-port-reservations](ideas/install-time-runtime-port-reservations.md) — Promoted
- [ideas/manual-port-assignment](ideas/manual-port-assignment.md) — Implemented 2026-07-18 (unit-tested; not yet exercised against a live Core)
- [ideas/marketplace-system-app](ideas/marketplace-system-app.md) — Promoted
- [ideas/one-click-cloudflare-ingress](ideas/one-click-cloudflare-ingress.md) — Promoted
...
- [planning/install-time-runtime-port-reservations](planning/install-time-runtime-port-reservations.md) — Ready
- [planning/marketplace-system-app](planning/marketplace-system-app.md) — Implemented
- [planning/one-click-cloudflare-public-ingress](planning/one-click-cloudflare-public-ingress.md) — Ready
