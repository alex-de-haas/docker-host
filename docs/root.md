...
- [CLI trusted control and dev metadata](features/cli-trusted-control-and-dev-metadata.md) - local no-token CLI control channel, Host-owned module lifecycle, and repository-local dev manifest workflow.
