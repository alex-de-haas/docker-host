...
[Hosty platform vision](vision.md), the umbrella that individual
...
- **ai-agent-bridge** — [feature](features/ai-agent-bridge/feature.md) · [plan](features/ai-agent-bridge/plan.md): In Progress, updated 2026-09-26
- **ai-gateway** — [feature](features/ai-gateway/feature.md) · [plan](features/ai-gateway/plan.md): In Progress, updated 2026-09-18
...
- **app-authoring** — [plan](features/app-authoring/plan.md): Draft, updated 2026-09-26
...
- **app-development-controls** — [plan](features/app-development-controls/plan.md): Draft, updated 2026-09-26
...
- **app-prototype-workspaces** — [plan](features/app-prototype-workspaces/plan.md): Draft, updated 2026-09-26
- **app-provided-skills** — [feature](features/app-provided-skills/feature.md)
- **app-publication** — [plan](features/app-publication/plan.md): Draft, updated 2026-09-26
- **app-readiness** — [feature](features/app-readiness/feature.md)
- **app-sandbox-runtimes** — [plan](features/app-sandbox-runtimes/plan.md): Draft, updated 2026-09-26
...
- **assistant-ahp** — [plan](features/assistant-ahp/plan.md): Draft, updated 2026-09-26
- **assistant-app-context** — [feature](features/assistant-app-context/feature.md)
- **assistant-approval-rules** — [plan](features/assistant-approval-rules/plan.md): Draft, updated 2026-09-26
- **assistant-attachments** — [feature](features/assistant-attachments/feature.md)
- **assistant-development-sessions** — [plan](features/assistant-development-sessions/plan.md): Draft, updated 2026-09-26
- **assistant-entry-points** — [feature](features/assistant-entry-points/feature.md) · [plan](features/assistant-entry-points/plan.md): In Progress, updated 2026-09-26
- **assistant-external-session-context** — [plan](features/assistant-external-session-context/plan.md): Draft, updated 2026-09-26
- **assistant-pr-lifecycle** — [plan](features/assistant-pr-lifecycle/plan.md): Draft, updated 2026-09-26
- **assistant-provider-permissions** — [plan](features/assistant-provider-permissions/plan.md): Draft, updated 2026-09-26
- **assistant-session-workspaces** — [plan](features/assistant-session-workspaces/plan.md): Draft, updated 2026-09-26
...
- **core-extension-model** — [plan](features/core-extension-model/plan.md): Draft, updated 2026-09-26
...
- **hosty-harness-rename** — [plan](features/hosty-harness-rename/plan.md): Draft, updated 2026-09-26
- **hosty-harness-swift** — [plan](features/hosty-harness-swift/plan.md): Draft, updated 2026-09-26
...
- **mcp-facade** — [feature](features/mcp-facade/feature.md) · [plan](features/mcp-facade/plan.md): Draft, updated 2026-09-26
