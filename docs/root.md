...
- [Automatic runtime app ports](features/automatic-runtime-app-ports/feature.md) - Core-assigned local ports and `PORT` compatibility behavior.
...
- **automatic-runtime-app-ports** — [feature](features/automatic-runtime-app-ports/feature.md)
