...
[Core development mode](../features/core-dev-target/feature.md) already **rejected** giving Core an `app.0.1` manifest
...
- [Core development mode](../features/core-dev-target/feature.md) — the platform panel that hosts this, and the rejected
