...
function mergeLegacyModulesWithAppRecords(
  ...
  const mergedModules = legacyStore.modules.map(module => {
    ...
    return {
      ...
      processes: app.processes ?? module.processes,
      runtimeKind: app.runtimeKind ?? module.runtimeKind,
      sourceState: app.sourceState ?? module.sourceState,
...
function appRecordToInstalledModuleRecord(
  ...
  return {
    ...
    ...(app.runtimeKind ? { runtimeKind: app.runtimeKind } : {}),
    ...(app.sourceState ? { sourceState: app.sourceState } : {}),
    ...(app.metadataDigest ? { metadataDigest: app.metadataDigest } : {}),
    ...(app.planDigest ? { planDigest: app.planDigest } : {}),
    containers: app.containers ?? [],
    ...(app.processes ? { processes: app.processes } : {}),
...
function installedModuleRecordToAppRecord(module: InstalledModuleRecord): InstalledAppRecord {
  ...
  return {
    ...
    ...(module.runtimeKind ? { runtimeKind: module.runtimeKind } : {}),
    ...(module.sourceState ? { sourceState: module.sourceState } : {}),
    ...
    ...(module.processes ? { processes: module.processes } : {}),
