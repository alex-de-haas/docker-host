...
[JsonSerializable(typeof(CloudflareDnsListResponse))]
[JsonSerializable(typeof(CloudflareDnsRecordResponse))]
[JsonSerializable(typeof(CloudflareDnsDeleteResponse))]
[JsonSerializable(typeof(CloudflarePublicationSet))]
[JsonSerializable(typeof(CloudflarePublishRequest))]
[JsonSerializable(typeof(CloudflareCorePublishRequest))]
...
[JsonSerializable(typeof(CoreDevelopmentState))]
[JsonSerializable(typeof(CoreSourceRequest))]
[JsonSerializable(typeof(CoreRestartRequest))]
[JsonSerializable(typeof(Haas.Hosty.Launch.CoreLaunchOperation))]
[JsonSerializable(typeof(Haas.Hosty.Launch.CoreSourceSettings))]
...
[JsonSerializable(typeof(DeviceAuthorizationCodeRequest))]
[JsonSerializable(typeof(DeviceAuthorizationCodeResponse))]
[JsonSerializable(typeof(DeviceAuthorizationTokenRequest))]
[JsonSerializable(typeof(DeviceAuthorizationTokenResponse))]
[JsonSerializable(typeof(DeviceAuthorizationDecisionRequest))]
[JsonSerializable(typeof(DeviceAuthorizationDecisionResponse))]
[JsonSerializable(typeof(DeviceAuthorizationRequestListResponse))]
[JsonSerializable(typeof(AccessTokenListResponse))]
[JsonSerializable(typeof(AccessTokenLabelRequest))]
...
[JsonSerializable(typeof(OnBehalfOfTokenRequest))]
// OAuth authorization server: persisted state, wire shapes (snake_case via JsonPropertyName), and
// the Shell-facing consent contracts.
...
[JsonSerializable(typeof(OAuthTokenErrorResponse))]
[JsonSerializable(typeof(OAuthRegistrationRequest))]
[JsonSerializable(typeof(OAuthRegistrationResponse))]
[JsonSerializable(typeof(OAuthConsentView))]
[JsonSerializable(typeof(OAuthDecisionRequest))]
[JsonSerializable(typeof(OAuthDecisionResponse))]
[JsonSerializable(typeof(OAuthClientListResponse))]
